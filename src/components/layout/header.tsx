      ...
      <div className="flex items-center space-x-2 sm:space-x-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center space-x-1.5 bg-blue-50 hover:bg-blue-100 text-blue-900 px-2.5 py-1.5 rounded-xl border border-blue-200 text-xs font-bold transition-colors"
          >

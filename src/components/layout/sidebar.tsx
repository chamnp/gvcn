...
const SidebarContent: React.FC<{ onClose?: () => void }> = ({ onClose }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-slate-900 text-slate-200">
      ...
      <div className="mx-3 sm:mx-4 my-3 p-3 rounded-xl bg-slate-800/80 border border-slate-700/60 shadow-xs">
        <div className="flex items-center justify-between mb-1">
          <span className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Lớp Chủ Nhiệm</span>
        ...
        <div className="mt-2 flex items-center justify-between text-[11px] text-slate-400 pt-1.5 border-t border-slate-700/50">

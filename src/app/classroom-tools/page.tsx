  ...
  const TOOLS: ClassroomToolItem[] = useMemo(
    () => [
      ...
      // 6. Mystery Chest
      {
        ...
        keyNumber: '6',
        category: 'INTERACTION',
        title: 'Hộp Quà Bí Mật — Khen Thưởng & Đố Vui',
        shortTitle: 'Hộp Quà',
        desc: 'Tuỳ chỉnh số lượng hộp quà, phần thưởng hoặc câu hỏi/thử thách, xáo trộn thứ tự 3D hồi hộp.',
        iconEmoji: '🎁',
        tag: 'Khen Thưởng & Đố Vui',
